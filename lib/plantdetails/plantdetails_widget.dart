...
export 'plantdetails_model.dart';

class PlantdetailsWidget extends StatefulWidget {
  const PlantdetailsWidget({Key? key}) : super(key: key);

  @override
  _PlantdetailsWidgetState createState() => _PlantdetailsWidgetState();
}
            ...
            Row(
              ...
              children: [
                Padding(
                  ...
                  child: Image.asset(
                    'assets/images/background_leaves.jpg',
